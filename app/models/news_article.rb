...
class NewsArticle < ApplicationRecord
  ...
  # Identification must also run for feed-only articles. The identifier gets
  # the best text available (title/preview/body) and decides whether it is
  # confident enough to create a game relation.
